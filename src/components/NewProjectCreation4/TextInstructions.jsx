...
const Text = () => {
  return (
    <div style={styles.Text}>
      ...
      <strong>1. Remove Any Leading Rows:</strong> The first row of your Excel sheet should contain the headers or titles of your data columns. Any rows above this should be deleted prior to uploading.<br />
      ...
      <strong>4. Upload:</strong> Once you've prepared your Excel file according to the above instructions, proceed to upload it using the button below.
    </div>
  );
};
