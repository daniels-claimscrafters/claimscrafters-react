...
const handleLogout = () => {
  ...
  <>
    ...
    <motion.div
      ...
      whileHover={{ scale: 1.1 }} // Scale up to 1.1 when hovered
      transition={{ duration: 1.0 }}
      style={{ width: 200, height: 100, display: "flex", justifyContent: "center", alignItems: "center" }}
    >
      <ButtonSignIn />
    </motion.div>
          </>
              ...
              <div className="col-md-4">
                <div className="box">
                  ...
                  <div className="detail-box">
                    ...
                    <p>
                    The need for speed in claims
settlement creates stress for
insurance professionals, who
must balance accuracy and
efficiency amidst a constant
stream of requests. This
workload overload can lead to
valuation errors affecting
...
accuracy is crucial for the
insurance industry. As settlement
times shrink and service levels
become paramount, adapting to
meet customer demands becomes
essential in an era of instant
gratification. This pivotal moment
in insurance history will redefine
industry standards.
                    </p>
              ...
              <div className="col-md-4">
                <div className="box">
                  ...
                  <div className="detail-box">
                    ...
                    <p>
                    Claims Crafters has
harnessed the power of AI to
revolutionize the contents
valuation process.
ContentsIQ is an AI powered
platform that enables swift
and accurate valuations of
insured contents, allowing
insurers to respond rapidly,
departing from past lengthy
wait times.
                    </p>
        ...
        <div className="why_container">
          <div className="box">
            ...
            <div className="detail-box">
              <h5>Submission</h5>
              <p>
              User registers and creates a
new, unique ContentsIQ project
related to a claim. Next, the
user is guided to easily upload
the contents inventory data
from Excel into ContentsIQ .
Eliminating the need to
manually enter data and/or
lookup values.   </p>
            </div>
          </div>
          <div className="box">
...
ContentIQ’s applies its AI
engines to determine a
Replacement Cost Value
(RCV), Actual Cash Value
(ACV) and assigns a Class
and Subclass to determine
the Depreciated value for
each item.
              </p>
            </div>
          </div>
          <div className="box">
            ...
            <div className="detail-box">
              <h5>Completion</h5>
              <p>
              Once the Processing has
been completed, a
comprehensive assessment
of the contents inventory
value will be made available
for the user to view, make
changes if necessary and
download and/or share via
email.             </p>
            </div>
          </div>
