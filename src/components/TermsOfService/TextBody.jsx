...
2. About the Website and Claims Crafters' Role

Our company and our online application, ContentsIQ, specializes in providing residential content valuations within the insurance industry. We offer detailed assessments of household contents for insurance purposes, helping to accurately value items in case of insurance claims. It is important for our users to understand that we do not provide insurance services, nor do we review insurance claims beyond the scope of content valuation. Our expertise is strictly limited to the assessment and valuation of residential contents for insurance purposes.

Our website offers users content, functionality, and services related specifically to insurance contents valuations. While we may provide tools or information that could be used in the context of insurance claims, we do not offer claims-related advice, process insurance claims, remedy claims, or negotiate claims on behalf of homeowners, insurance carriers, or their partners and representatives.

Users of our website should be aware that while we may facilitate information exchange related to contents valuation, we are not a party to any insurance claims or agreements between users and their insurance carriers or any third party. Our role is exclusively that of a valuation service provider.
Furthermore, we are not an insurer, insurance agent, or legal advisor. While we may provide general information about the valuation process and its relevance to insurance claims, any legal or insurance-related decisions should be made in consultation with qualified professionals in those respective fields. Users are encouraged to seek legal or insurance advice before making decisions based on the valuations provided by our services.
...
We do not use third-party services to verify the identity of users on our Website. Therefore, while we implement certain measures to assist users in avoiding potentially fraudulent or illegal activities, we cannot assure the effectiveness of these measures or the accuracy of any user's identity. Any indication that a user's identity has been verified only means that the user has met the criteria set by our internal processes and does not guarantee the true identity of the person. You assume the risk of transacting business with other users or third parties through the Website.
 
The Website may include content from third parties, such as materials from users  and third-party licensors, syndicators, aggregators, and reporting services. Statements and opinions expressed in these materials, and all articles, responses to questions, and other content, except for that clearly provided by us, are the opinions and responsibility of the providers of those materials. These do not necessarily reflect our opinion. We are not responsible or liable for the content or accuracy of any third-party materials.

9. Financial Data

For the processing of credit card transactions, we utilize the services of Stripe, Inc. (“Stripe”). By engaging in financial transactions on our Website, you authorize us and Stripe to handle your credit card information. This includes granting the necessary rights, power, and authority to Stripe to access, transmit, and manage your personal and financial data as required for processing your transactions. It is important to note that your personal and financial information will be transferred, stored, and processed by Stripe in a manner consistent with the Stripe Privacy Policy.  We prioritize the security and confidentiality of your financial data, and the use of Stripe's services is integral to ensuring a secure and efficient processing of your financial transactions on our Website
...
·       To the extent we provide social media features including, but not exclusively, links with Facebook, X, YouTube, Instagram or LinkedIn, you may take such actions as are enabled by such features consistent with their terms of use.
You must not:
...
·       If you wish to make any use of material on the Website other than that set out in this section, please address your request to: contents@claimscrafters.com.
...
The Claims Crafters and ContentsIQ name, the term “Claims Crafters”, “ContentIQ”,  the Claims Crafter logo, the ContentsIQ and all related names, logos, product and service names, designs and slogans are trademarks of Claims Crafters or its affiliates or licensors. You must not use such marks without our prior written permission. All other names, logos, product and service names, designs and slogans on this Website are the trademarks of their respective owners.
...
We are based in the state of Florida in the United States. We provide the Website for use only by persons located in the United States. We make no claims that the Website or any of its content is accessible or appropriate outside of the United States. Access to the Website may not be legal by certain persons or in certain countries. If you access the Website from outside the United States, you do so on your own initiative and are responsible for compliance with local laws.
...
The Terms are governed by and shall be construed in accordance with the laws of the State of Florida without regard to its conflict of laws rules.  Subject to Florida Statute Florida Statute §47.011, any legal proceedings against us that may arise out of, relate to, or be in any way connected with the Website or the Terms shall be brought exclusively in the state or federal courts located in the City and County of St. Petersburg (Pinellas County), Florida , and you waive any jurisdictional, venue, or inconvenient forum objections to such courts.

22. Dispute Resolution

We and you each agree to make an initial attempt to resolve any disputes by contacting each other and providing a written description of the issue, along with all relevant documents/information, and the proposed resolution. You can reach us with disputes by emailing us at support@claimscrafters.com, and we will attempt to contact you based on the contact information you have provided.

If after 30 days, we are unable to resolve a dispute, then the dispute may be submitted to arbitration in accordance with this section. You acknowledge that, without this provision, you would have had the right or opportunity to litigate the dispute in a court and have it decided by a judge or jury.

Accordingly, any dispute between you and any Indemnified Party (including, as permitted by applicable law, third parties who are not signatories to this agreement) that is not resolved through negotiation, including disputes over the validity or applicability of this arbitration clause, shall be resolved by binding arbitration administered by JAMS under its rules and procedures as they exist when the claim is filed. All arbitration claims should be filed with the Florida JAMS Office. You can find rules, procedures, and fee information on JAMS’ website (www.jamsadr.com) or by contacting the Florida office of JAMS.

This arbitration agreement is part of a transaction involving interstate commerce, and therefore it and any proceedings under it will be governed by the Federal Arbitration Act (“FAA”), 9 U.S.C. §§ 1-16. Any award by the arbitrator(s) can be entered as a judgment in any court with jurisdiction.

Notwithstanding the above, we both agree that: (a) if you fail to timely pay amounts due, we may assign your account for collection, and the collection agency may pursue court claims strictly limited to collecting the past due debt and any permissible interest or collection costs; (b) either party may take disputes over the validity of any party’s intellectual property rights to a court of competent jurisdiction; (c) disputes related to or arising from allegations of fraudulent or unauthorized use, theft, or piracy of service may be brought in a court of competent jurisdiction; (d) either party may seek any interim or preliminary relief from a court of competent jurisdiction, necessary to protect rights or property pending the completion of arbitration; and (e) disputes within the jurisdiction of an applicable small claims court may be brought in that court instead of arbitration.

Further, we agree that any arbitration will be solely between you and the Indemnified Party, not as part of a class claim. If any court or arbitrator finds this restriction to be unconscionable or unenforceable, then the agreement to arbitrate does not apply and the class-wide dispute must be brought in court.
