...
const handleChange = (fieldName, value) => {
  ...
  if (fieldName === 'streetAddress' || fieldName === 'city' || fieldName === 'title' || fieldName === 'organization' ) {
...
<input id="file-input" type="file" accept="image/*" onChange={(e) => handleImageChange(e.target.files[0])} style={{ display: 'none' }} />
  ...
  />
                  ...
                  {/* Row 5 */}
                  <div style={{ display: 'flex', width: '565px', marginBottom: '20px', justifyContent: 'left', gap: '10px' }}>
                      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', width: '239px' }}>
                          <TextCity />
                          <div style={{ justifyContent: 'center' }}> {/* Center the input field horizontally */}
                          <InputFieldCity 
    value={formData.city} 
...
/>
                  ...
                  {/* Row 6 */}
                  <div style={{ display: 'flex', width: '565px', marginBottom: '20px', justifyContent: 'left', gap: '80px' }}>
                      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '239px' }}>
                          <TextPostalCode />
                          <div style={{ justifyContent: 'center' }}> {/* Center the input field horizontally */}
