...
const confirmMappingDisabled = !selectedDescription || !selectedQuantity || !submitDisabled;
...
const handleDeleteRow = (rowIndex) => {
  ...
  return (
    <div style={styles.cardContainer}>
      ...
      <label style={styles.label} htmlFor="selectedWorksheet">Worksheet: </label>
      <select 
...
<option value="" disabled selected hidden>Select Column</option>
  ...
  <label style={styles.label} htmlFor="selectedQuantity">Quantity: </label>
  <select
  id="selectedQuantity"
  style={styles.inputField}
...
<button style={{
    ...styles.button1,
    backgroundColor: confirmMappingDisabled ? '#ccc' : styles.button1.backgroundColor
  }} disabled={confirmMappingDisabled} onClick={handleConfirmMapping}>
  Confirm Column Mapping
      ...
      <button
        ...
        style={{
          ...styles.button3,
          backgroundColor: startOverDisabled ? '#ccc' : styles.button3.backgroundColor
        }}
      >
        Restart
      </button>
      <button 
        ...
        style={{
          ...styles.button4,
          backgroundColor: submitDisabled ? '#ccc' : styles.button4.backgroundColor
        }}
      >
        Submit
      </button>
